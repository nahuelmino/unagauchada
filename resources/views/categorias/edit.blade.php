        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" role="form" method="POST" action="/admin/categorias/{{$categoria['id']}}/edit" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $categoria->name }}" required autofocus>
